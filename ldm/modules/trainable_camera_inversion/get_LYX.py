...
import torch
from amplitude import TrainableCameraInversion

# 定义设备
device = torch.device('cuda')

# 定义模型
trainablecamerainversion = TrainableCameraInversion(initial_mode='calibration', image_size=128, data_code='0104').to(
    device)
...
# 读取文件夹中的所有图像
input_dir = r"D:\cqy\flat_data\0104\eval\measure_resize"
output_dir = r"D:\cqy\stableSR\CFW_data\eval_data\amplitude_128_calibration\LYR"
